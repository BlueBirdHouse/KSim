...
struct sKhepera3Motor {
	...
	long current_speed;								//!< Current speed (updated by khepera3_motor_get_current_speed)
	unsigned long current_position;							//!< Current position (updated by khepera3_motor_get_current_position)
