...
static const char * c3_debug_family_names[9] = { "Temp", "nargin", "nargout",
  "V_x", "V_y", "Phi", "l_offset", "v", "w" };

/* Function Declarations */
static void initialize_c3_BlueBird_Formation
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance);
static void initialize_params_c3_BlueBird_Formation
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance);
static void enable_c3_BlueBird_Formation(SFc3_BlueBird_FormationInstanceStruct
  *chartInstance);
static void disable_c3_BlueBird_Formation(SFc3_BlueBird_FormationInstanceStruct *
  chartInstance);
static void c3_update_debugger_state_c3_BlueBird_Formation
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_BlueBird_Formation
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance);
static void set_sim_state_c3_BlueBird_Formation
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance, const mxArray *c3_st);
static void finalize_c3_BlueBird_Formation(SFc3_BlueBird_FormationInstanceStruct
  *chartInstance);
static void sf_gateway_c3_BlueBird_Formation
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance);
static void c3_chartstep_c3_BlueBird_Formation
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance);
static void initSimStructsc3_BlueBird_Formation
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_BlueBird_FormationInstanceStruct
  *chartInstance, const mxArray *c3_w, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_BlueBird_FormationInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_BlueBird_FormationInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[2]);
...
static void c3_eml_scalar_eg(SFc3_BlueBird_FormationInstanceStruct
  *chartInstance);
static void c3_threshold(SFc3_BlueBird_FormationInstanceStruct *chartInstance);
static void c3_b_eml_scalar_eg(SFc3_BlueBird_FormationInstanceStruct
  *chartInstance);
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_BlueBird_FormationInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_e_emlrt_marshallIn(SFc3_BlueBird_FormationInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_BlueBird_Formation, const
  char_T *c3_identifier);
static uint8_T c3_f_emlrt_marshallIn(SFc3_BlueBird_FormationInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_BlueBird_FormationInstanceStruct
  *chartInstance);
  ...
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_BlueBird_Formation = 0U;
}
  ...
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance)
{
  ...
  c3_c_hoistedGlobal = chartInstance->c3_is_active_c3_BlueBird_Formation;
  ...
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance, const mxArray *c3_st)
{
  ...
  *c3_w = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 1)),
    "w");
  chartInstance->c3_is_active_c3_BlueBird_Formation = c3_e_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 2)),
     "is_active_c3_BlueBird_Formation");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_BlueBird_Formation(chartInstance);
  ...
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance)
{
  ...
  real_T *c3_w;
  c3_w = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c3_l_offset = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c3_Phi = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c3_v = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_V_y = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c3_V_x = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_SYMBOL_SCOPE_PUSH(0U, 0U);
  _sfTime_ = sf_get_time(chartInstance->S);
  _SFD_CC_CALL(CHART_ENTER_SFUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  _SFD_DATA_RANGE_CHECK(*c3_V_x, 0U);
  _SFD_DATA_RANGE_CHECK(*c3_V_y, 1U);
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_BlueBird_Formation(chartInstance);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_BlueBird_FormationMachineNumber_,
    chartInstance->chartNumber, chartInstance->instanceNumber);
  _SFD_DATA_RANGE_CHECK(*c3_v, 2U);
  _SFD_DATA_RANGE_CHECK(*c3_Phi, 3U);
  _SFD_DATA_RANGE_CHECK(*c3_l_offset, 4U);
  _SFD_DATA_RANGE_CHECK(*c3_w, 5U);
}
  ...
  (SFc3_BlueBird_FormationInstanceStruct *chartInstance)
{
  ...
  real_T *c3_b_V_y;
  real_T *c3_b_Phi;
  real_T *c3_b_l_offset;
  real_T *c3_b_v;
  real_T *c3_b_w;
  c3_b_w = (real_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c3_b_l_offset = (real_T *)ssGetInputPortSignal(chartInstance->S, 3);
  c3_b_Phi = (real_T *)ssGetInputPortSignal(chartInstance->S, 2);
  c3_b_v = (real_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_b_V_y = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
  c3_b_V_x = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
  _SFD_CC_CALL(CHART_ENTER_DURING_FUNCTION_TAG, 2U, chartInstance->c3_sfEvent);
  c3_hoistedGlobal = *c3_b_V_x;
  c3_b_hoistedGlobal = *c3_b_V_y;
  c3_c_hoistedGlobal = *c3_b_Phi;
  c3_d_hoistedGlobal = *c3_b_l_offset;
  c3_V_x = c3_hoistedGlobal;
  c3_V_y = c3_b_hoistedGlobal;
  c3_Phi = c3_c_hoistedGlobal;
  c3_l_offset = c3_d_hoistedGlobal;
  _SFD_SYMBOL_SCOPE_PUSH_EML(0U, 9U, 9U, c3_debug_family_names,
    c3_debug_family_var_map);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(c3_Temp, 0U, c3_b_sf_marshallOut,
    c3_b_sf_marshallIn);
  ...
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_nargout, 2U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_V_x, 3U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_V_y, 4U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_Phi, 5U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML(&c3_l_offset, 6U, c3_sf_marshallOut);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_v, 7U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  _SFD_SYMBOL_SCOPE_ADD_EML_IMPORTABLE(&c3_w, 8U, c3_sf_marshallOut,
    c3_sf_marshallIn);
  CV_EML_FCN(0, 0);
  _SFD_EML_CALL(0U, chartInstance->c3_sfEvent, 4);
  if (CV_EML_IF(0, 1, 0, c3_l_offset > 0.0)) {
    ...
    for (c3_i2 = 0; c3_i2 < 2; c3_i2++) {
      ...
      for (c3_i4 = 0; c3_i4 < 2; c3_i4++) {
        c3_e_y[c3_i3 + c3_i2] = 0.0;
        c3_i5 = 0;
        for (c3_i6 = 0; c3_i6 < 2; c3_i6++) {
          c3_e_y[c3_i3 + c3_i2] += c3_a[c3_i5 + c3_i2] * c3_b[c3_i6 + c3_i3];
          c3_i5 += 2;
        }
    ...
    for (c3_i9 = 0; c3_i9 < 2; c3_i9++) {
      c3_C[c3_i9] = c3_Temp[c3_i9];
    }

    for (c3_i10 = 0; c3_i10 < 2; c3_i10++) {
      c3_Temp[c3_i10] = c3_C[c3_i10];
    }

    c3_threshold(chartInstance);
    for (c3_i11 = 0; c3_i11 < 2; c3_i11++) {
      c3_C[c3_i11] = c3_Temp[c3_i11];
    }

    for (c3_i12 = 0; c3_i12 < 2; c3_i12++) {
      c3_Temp[c3_i12] = c3_C[c3_i12];
    }
    ...
    for (c3_i13 = 0; c3_i13 < 2; c3_i13++) {
      ...
      for (c3_i15 = 0; c3_i15 < 2; c3_i15++) {
        c3_Temp[c3_i13] += c3_e_y[c3_i14 + c3_i13] * c3_b_b[c3_i15];
        c3_i14 += 2;
      }
    }
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_BlueBird_FormationInstanceStruct *chartInstance;
  chartInstance = (SFc3_BlueBird_FormationInstanceStruct *)chartInstanceVoid;
  ...
  *chartInstance, const mxArray *c3_w, const char_T *c3_identifier)
{
  ...
  c3_y = c3_b_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_w), &c3_thisId);
  sf_mex_destroy(&c3_w);
  return c3_y;
}
  ...
  *c3_inData)
{
  ...
  for (c3_i16 = 0; c3_i16 < 2; c3_i16++) {
    c3_b_inData[c3_i16] = (*(real_T (*)[2])c3_inData)[c3_i16];
  }
  ...
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData)
{
  ...
  SFc3_BlueBird_FormationInstanceStruct *chartInstance;
  chartInstance = (SFc3_BlueBird_FormationInstanceStruct *)chartInstanceVoid;
  c3_Temp = sf_mex_dup(c3_mxArrayInData);
  c3_identifier = c3_varName;
  c3_thisId.fIdentifier = c3_identifier;
  c3_thisId.fParent = NULL;
  c3_c_emlrt_marshallIn(chartInstance, sf_mex_dup(c3_Temp), &c3_thisId, c3_y);
  sf_mex_destroy(&c3_Temp);
  for (c3_i19 = 0; c3_i19 < 2; c3_i19++) {
    (*(real_T (*)[2])c3_outData)[c3_i19] = c3_y[c3_i19];
  }

  sf_mex_destroy(&c3_mxArrayInData);
}

const mxArray *sf_c3_BlueBird_Formation_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c3_identifier)
{
  ...
  c3_y = c3_f_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_BlueBird_Formation), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_BlueBird_Formation);
  return c3_y;
}
...
void sf_c3_BlueBird_Formation_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1897912473U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3370218125U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(481742877U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1456096700U);
}

mxArray *sf_c3_BlueBird_Formation_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("0mLomB2pn7ycyr9uuFC5PD");
...
mxArray *sf_c3_BlueBird_Formation_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_BlueBird_Formation_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_BlueBird_Formation(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x3'type','srcId','name','auxInfo'{{M[1],M[5],T\"v\",},{M[1],M[9],T\"w\",},{M[8],M[0],T\"is_active_c3_BlueBird_Formation\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 3, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_BlueBird_Formation_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_BlueBird_FormationInstanceStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,1,1,0,"V_y");
          _SFD_SET_DATA_PROPS(2,2,0,1,"v");
          _SFD_SET_DATA_PROPS(3,1,1,0,"Phi");
          _SFD_SET_DATA_PROPS(4,1,1,0,"l_offset");
          _SFD_SET_DATA_PROPS(5,2,0,1,"w");
        ...
        _SFD_CV_INIT_EML_IF(0,1,0,103,118,246,276);
...

        {
          ...
          c3_V_y = (real_T *)ssGetInputPortSignal(chartInstance->S, 1);
          c3_V_x = (real_T *)ssGetInputPortSignal(chartInstance->S, 0);
          _SFD_SET_DATA_VALUE_PTR(0U, c3_V_x);
          _SFD_SET_DATA_VALUE_PTR(1U, c3_V_y);
          _SFD_SET_DATA_VALUE_PTR(2U, c3_v);
          _SFD_SET_DATA_VALUE_PTR(3U, c3_Phi);
          _SFD_SET_DATA_VALUE_PTR(4U, c3_l_offset);
          _SFD_SET_DATA_VALUE_PTR(5U, c3_w);
        }
      }
    } else {
...
{
  return "1J6Y4d9eSZO9aKQRu3QnED";
}

static void sf_opaque_initialize_c3_BlueBird_Formation(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_BlueBird_FormationInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_BlueBird_Formation((SFc3_BlueBird_FormationInstanceStruct*)
    chartInstanceVar);
  initialize_c3_BlueBird_Formation((SFc3_BlueBird_FormationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_BlueBird_Formation(void *chartInstanceVar)
{
  enable_c3_BlueBird_Formation((SFc3_BlueBird_FormationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_BlueBird_Formation(void *chartInstanceVar)
{
  disable_c3_BlueBird_Formation((SFc3_BlueBird_FormationInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_BlueBird_Formation(void *chartInstanceVar)
{
  sf_gateway_c3_BlueBird_Formation((SFc3_BlueBird_FormationInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_BlueBird_Formation(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_BlueBird_Formation
    ((SFc3_BlueBird_FormationInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_BlueBird_Formation();/* state var info */
...
extern void sf_internal_set_sim_state_c3_BlueBird_Formation(SimStruct* S, const
  mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_BlueBird_Formation();/* state var info */
  ...
  set_sim_state_c3_BlueBird_Formation((SFc3_BlueBird_FormationInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_BlueBird_Formation(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_BlueBird_Formation(S);
}

static void sf_opaque_set_sim_state_c3_BlueBird_Formation(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_BlueBird_Formation(S, st);
}

static void sf_opaque_terminate_c3_BlueBird_Formation(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_BlueBird_FormationInstanceStruct*) chartInstanceVar)
      ->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c3_BlueBird_Formation((SFc3_BlueBird_FormationInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_BlueBird_Formation((SFc3_BlueBird_FormationInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_BlueBird_Formation(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_BlueBird_Formation
      ((SFc3_BlueBird_FormationInstanceStruct*)(chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_BlueBird_Formation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
  ...
  ssSetChecksum0(S,(3492664525U));
  ssSetChecksum1(S,(1937104465U));
  ssSetChecksum2(S,(2924566421U));
  ssSetChecksum3(S,(608354937U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
  ssSupportsMultipleExecInstances(S,1);
}

static void mdlRTW_c3_BlueBird_Formation(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_BlueBird_Formation(SimStruct *S)
{
  SFc3_BlueBird_FormationInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_BlueBird_FormationInstanceStruct *)utMalloc(sizeof
    (SFc3_BlueBird_FormationInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_BlueBird_FormationInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_BlueBird_Formation;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_BlueBird_Formation;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_BlueBird_Formation;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_BlueBird_Formation;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c3_BlueBird_Formation;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_BlueBird_Formation;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_BlueBird_Formation;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_BlueBird_Formation;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_BlueBird_Formation;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_BlueBird_Formation;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_BlueBird_Formation;
...
void c3_BlueBird_Formation_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_BlueBird_Formation(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_BlueBird_Formation(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_BlueBird_Formation(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_BlueBird_Formation_method_dispatcher.\n"
