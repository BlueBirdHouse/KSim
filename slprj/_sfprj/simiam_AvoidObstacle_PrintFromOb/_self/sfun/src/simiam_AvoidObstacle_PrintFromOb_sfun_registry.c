...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
  const mxArray * prhs[] )
{
  extern unsigned int sf_simiam_AvoidObstacle_PrintFromOb_process_check_sum_call
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_simiam_AvoidObstacle_PrintFromOb_process_check_sum_call(nlhs,plhs,nrhs,
       prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int sf_simiam_AvoidObstacle_PrintFromOb_autoinheritance_info
    ( int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "simiam_AvoidObstacle_PrintFromOb") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_simiam_AvoidObstacle_PrintFromOb_autoinheritance_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int sf_simiam_AvoidObstacle_PrintFromOb_third_party_uses_info(
    int nlhs, mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "simiam_AvoidObstacle_PrintFromOb") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_simiam_AvoidObstacle_PrintFromOb_third_party_uses_info(nlhs,plhs,3,
      newRhs);
  }
...
{
  extern unsigned int
    sf_simiam_AvoidObstacle_PrintFromOb_updateBuildInfo_args_info( int nlhs,
  ...
  if (strcmp(machineName, "simiam_AvoidObstacle_PrintFromOb") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_simiam_AvoidObstacle_PrintFromOb_updateBuildInfo_args_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_simiam_AvoidObstacle_PrintFromOb_get_eml_resolved_functions_info( int
  ...
  if (strcmp(machineName, "simiam_AvoidObstacle_PrintFromOb") == 0) {
    ...
    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    return sf_simiam_AvoidObstacle_PrintFromOb_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_simiam_AvoidObstacle_PrintFromOb_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"simiam_AvoidObstacle_PrintFromOb")) {
    return(sf_simiam_AvoidObstacle_PrintFromOb_method_dispatcher(simstructPtr,
...
extern void simiam_AvoidObstacle_PrintFromOb_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    simiam_AvoidObstacle_PrintFromOb_terminator();
...
extern void simiam_AvoidObstacle_PrintFromOb_initializer(void);
extern void simiam_AvoidObstacle_PrintFromOb_register_exported_symbols(SimStruct*
  S);
extern void simiam_AvoidObstacle_PrintFromOb_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  simiam_AvoidObstacle_PrintFromOb_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      simiam_AvoidObstacle_PrintFromOb_debug_initialize
        (sfGlobalDebugInstanceStruct);
    }

    simiam_AvoidObstacle_PrintFromOb_initializer();
  }
